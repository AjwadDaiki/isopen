    ...
    <>
      ...
      <div className="min-h-screen">
        <div className="max-w-[720px] mx-auto px-4 sm:px-6 py-12">
          <h1 className="text-3xl font-heading font-extrabold text-text tracking-tight mb-8">Terms of Service</h1>
          <div className="prose prose-sm text-muted2 space-y-6">
            <p className="text-muted font-mono text-xs">Last updated: February 2026</p>

            <section>
              <h2 className="text-lg font-bold text-text mt-8 mb-3">1. Service Description</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-text mt-8 mb-3">2. Accuracy of Information</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-text mt-8 mb-3">3. User Reports</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-text mt-8 mb-3">4. Intellectual Property</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-text mt-8 mb-3">5. Limitation of Liability</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-text mt-8 mb-3">6. Advertisements</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-text mt-8 mb-3">7. Changes to Terms</h2>
            ...
            <section>
              <h2 className="text-lg font-bold text-text mt-8 mb-3">8. Contact</h2>
